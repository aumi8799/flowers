...
@section('title', 'Įmonių Renginių Dekoravimas')

@section('content')
    <header class="py-5" style="background: url('{{ asset('images/header-bg.jpg') }}') no-repeat center center; background-size: cover; height: 200px; display: flex; align-items: center; justify-content: center;">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-dark-gray header-text">
                <h1 class="display-4 fw-bolder">Įmonių Renginių Dekoravimas</h1>
                <p class="lead fw-normal text-dark-gray mb-0">Profesionalios dekoracijos Jūsų įmonių renginiams.</p>
            </div>
        </div>
    </header>
    ...
    <section class="container my-5">
        ...
        <p>Mes siūlome profesionalias dekoracijas įmonių renginiams, kurios padės sukurti išskirtinę atmosferą Jūsų įmonės renginiuose. Galime pasiūlyti įvairius paketų pasirinkimus pagal Jūsų poreikius ir renginio pobūdį.</p>
    </section>

    <!-- Paslaugų paketai -->
    <section class="container my-5">
        <h2 class="text-center">Pasirinkite paslaugų paketą</h2>
        <form action="{{ route('decorations.order', ['type' => 'corporate']) }}" method="POST">
            @csrf
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nuo €800</p>
                            <ul>
                                <li>Susitikimai su organizatoriais</li>
                                <li>Apsilankymas renginio lokacijoje</li>
                                <li>Gėlių dekoracijos ir pasirinkimas</li>
                                <li>Tematinis stalo dekoravimas</li>
                                <li>Žiedlapiai ir paprastos dekoracijos</li>
                            </ul>
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li>Žiedlapiai ir papildomos dekoracijos</li>
                            </ul>
            ...
            <div id="orderForm" style="display:none;">
                ...
                <div class="form-group">
                    <label for="flowers">Ar norėtumėte įtraukti gėlių dekoracijas?</label>
                ...
                <div class="form-group">
                    <label for="style">Renginio stilistika</label>
                ...
                <div class="form-group">
                    <label for="comments">Kiti komentarai nuo organizatorių</label>
